...
2. Open Terminal in this folder:
   ...
   ```zsh
   cd "/Users/USERNAME/Desktop/Mac/los"
   ```
...
```zsh
tail -n 120 /Users/USERNAME/.lifeos/launchd.err.log
```

Launchd stdout log:

```zsh
tail -n 120 /Users/USERNAME/.lifeos/launchd.out.log
```
...
```text
/Users/USERNAME/Desktop/Mac/los
```

Operator command:

```text
/Users/USERNAME/.local/bin/operator
```

LaunchAgent plist:

```text
/Users/USERNAME/Library/LaunchAgents/com.lifeos.bot.plist
```

Launchd wrapper:

```text
/Users/USERNAME/.lifeos/run_lifeos_bot.sh
```
